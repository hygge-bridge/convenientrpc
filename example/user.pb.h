...
class LoginResponse :
 ...
 public:
  ...
  // .hygge.ResultCode res = 1;
  bool has_res() const;
  private:
  bool _internal_has_res() const;
  public:
  void clear_res();
  const ::hygge::ResultCode& res() const;
  ::hygge::ResultCode* release_res();
  ::hygge::ResultCode* mutable_res();
  void set_allocated_res(::hygge::ResultCode* res);
  private:
  const ::hygge::ResultCode& _internal_res() const;
  ::hygge::ResultCode* _internal_mutable_res();
  public:
...
inline const ::hygge::ResultCode& LoginResponse::_internal_res() const {
  const ::hygge::ResultCode* p = res_;
  return p != nullptr ? *p : *reinterpret_cast<const ::hygge::ResultCode*>(
      &::hygge::_ResultCode_default_instance_);
}
inline const ::hygge::ResultCode& LoginResponse::res() const {
  // @@protoc_insertion_point(field_get:hygge.LoginResponse.res)
  return _internal_res();
}
inline ::hygge::ResultCode* LoginResponse::release_res() {
  // @@protoc_insertion_point(field_release:hygge.LoginResponse.res)
  
  ::hygge::ResultCode* temp = res_;
  res_ = nullptr;
  return temp;
}
inline ::hygge::ResultCode* LoginResponse::_internal_mutable_res() {
...
inline ::hygge::ResultCode* LoginResponse::mutable_res() {
  // @@protoc_insertion_point(field_mutable:hygge.LoginResponse.res)
  return _internal_mutable_res();
}
inline void LoginResponse::set_allocated_res(::hygge::ResultCode* res) {
  ...
  res_ = res;
  // @@protoc_insertion_point(field_set_allocated:hygge.LoginResponse.res)
}
